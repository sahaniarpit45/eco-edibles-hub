...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Use it. Eat it. Or compost it. Three simple steps to a zero-waste meal.",
      },
    ],
  }),
  ...
  const steps = [
    {
      icon: Utensils,
      t: "Use it",
      d: "Stir, scoop or sip — durable for 15–20 minutes in hot or cold food.",
    },
    {
      icon: Cookie,
      t: "Eat it",
      d: "When the meal is done, enjoy a wholesome, crunchy bite of millets.",
    },
    {
      icon: Sprout,
      t: "Or compost it",
      d: "Toss it in organic waste — fully biodegradable in days, not centuries.",
    },
  ];
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Three steps to <em className="not-italic text-gradient-gold">zero waste</em>
          </>
        }
      />
        ...
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-3 gap-8 relative">
          ...
          {steps.map((s, i) => (
            <div key={s.t} className="relative text-center">
              ...
              <div className="mt-4 font-display text-sm uppercase tracking-[0.3em] text-primary">
                Step 0{i + 1}
              </div>
