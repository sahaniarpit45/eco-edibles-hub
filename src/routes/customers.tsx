  ...
  head: () => ({
    meta: [
      { title: "Happy Customers — Just Bite" },
      {
        name: "description",
        content:
          "Watch real customer reactions to Just Bite edible cutlery — premium video testimonials.",
      },
    ],
  }),
  component: Customers,
...
const TESTIMONIALS = [
  {
    name: "Aditi R.",
    role: "Café Owner, Bhubaneswar",
    q: "Our customers love the novelty — and we love being plastic-free.",
    r: 5,
  },
  {
    name: "Rahul M.",
    role: "Event Manager",
    q: "We served 800 guests with Just Bite spoons. Zero plastic. Zero complaints.",
    r: 5,
  },
  {
    name: "Sneha P.",
    role: "Conscious Consumer",
    q: "Tasty, sturdy, and guilt-free. I order them for every dinner party.",
    r: 5,
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Real bites. <em className="not-italic text-gradient-gold">Real love.</em>
          </>
        }
        sub="Watch what our customers and partners are saying about Just Bite."
      />
              ...
              <div className="p-6 md:p-8 flex flex-wrap items-center justify-between gap-4 border-t border-border/40">
                <div>
                  ...
                  <p className="mt-2 font-display text-xl text-gradient-gold">
                    "A delicious revolution on every spoon."
                  </p>
      ...
      <section className="py-20 bg-onyx/40">
        <div className="mx-auto max-w-7xl px-6">
          <SectionHeader
            ...
            title={
              <>
                What people are <em className="not-italic text-gradient-gold">saying</em>
              </>
            }
          />
